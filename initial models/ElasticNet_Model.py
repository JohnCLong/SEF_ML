...
y_ela_prediction = ela.predict(X_test)
ela_mse = mean_squared_error(y_test, y_ela_prediction)
...
ela_scores = cross_val_score(ela, X_test, y_test, scoring="neg_mean_squared_error", cv=10)
